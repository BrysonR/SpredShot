          ...
          return (
            React.createElement("div", {className: "card", style: cardStyle}, 
              ...
              React.createElement("div", {className: "card-body"}, 
                ...
                React.createElement("div", {className: "card-price"}, this.props.price)
              )
            )
          );
        }
    ...
    var CardCollection = React.createClass({displayName: "CardCollection",
      render: function() {
        var Cards = this.props.data.map(function (listing) {
          ...
          {
            return (
                React.createElement(Card, {key: listing._id, imageUrl: listing._source.imageUrl, title: listing._source.title, price: listing._source.price, url: listing._source.link})
            );
          }
        });

        return (
          React.createElement("div", {className: "card-collection"}, 
            React.createElement("div", {className: "welcome-card"}, 
              React.createElement("h1", null, "Welcome To Guns N Fun"), 
              React.createElement("h4", null, "Enjoy :)")
            ), 
    ...
    return (
        React.createElement("html", null, 
          React.createElement("head", null, 
            React.createElement("meta", {name: "viewport", content: "width=device-width, initial-scale=.5, user-scalable=no"}), 
			      React.createElement("title", null, "Guns N Fun"), 
            React.createElement("link", {rel: "stylesheet", href: "styles/css/index.css"}), 
            ...
            React.createElement("script", {src: "horizontalScrolling.js"}), 
